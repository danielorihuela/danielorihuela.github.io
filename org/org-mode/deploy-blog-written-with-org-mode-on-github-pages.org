...
#+description: Join me on my adventure to crafting a personal blog with Hugo, GitHub Pages, and GitHub Actions. Learn how to use these tools to create and deploy your own site effortlessly.
#+publishdate: 2022-07-03
#+cover: ../../images/covers/deploy-blog.png
#+options: ^:nil
