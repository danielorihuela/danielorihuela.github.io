...
#+description: Crack H4ck1ng G00gl3 ep004 challenge 01: explore endpoints, use .tar.gz files and dry run features, and trick the system into revealing the flag.
