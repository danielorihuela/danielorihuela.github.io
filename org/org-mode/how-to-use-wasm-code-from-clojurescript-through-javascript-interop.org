...
#+description: Learn to use WASM code in ClojureScript via JavaScript interop. Explore Rust functions, wasm-bindgen crate, and seamless integration with JS for efficient coding.
#+publishdate: 2023-06-10
#+cover: ../../images/covers/cljs-wasm-js.png
#+options: ^:nil
