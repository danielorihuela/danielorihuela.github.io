...
#+description: Learn how heap-based buffer overflows work and discover preventive measures to safeguard your code against them.
...
In a previous post, I explained what a [[../stack-based-buffer-overflows][stack-based buffer overflow]] is and how it works. Today, we are going to see the heap-based variant.
